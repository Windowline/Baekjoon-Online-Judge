...
/**
 * Application Configuration의 url을 설정합니다. 예) http://farm43.ids.onestore.co.kr:8012/hub/vsm_dev/config/application/TMAP.conf
 */
@property (strong, nonatomic) NSString *configUrl;

/**
 * 지도 타일, 교통 정보 등에 사용될 url의 prefix를 설정합니다. 예 http://farm43.ids.onestore.co.kr:8012/hub/vsm_dev
 */
